    ...
    <div class="absolute top-0">
        ...
        @if (strlen($search) >= 2)
            @if (count($searchResults) > 0)
              ...
              @else
                <div class="z-50 absolute custom-gray-3 text-sm rounded w-64 mt-4 scroll-300 shadow-2xl" x-show="isOpen">
                    <ul>
                        @foreach ($searchResults as $result)
                            <li class="custom-border-b-gray-2">
              ...
              @endif
            @else
                <div class="z-50 absolute custom-gray-3 text-sm rounded w-64 mt-4" x-show="isOpen">
